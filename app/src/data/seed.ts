...
export interface Persona {
  ...
  reach: string;
  /**
   * A licensed photograph, when there is one. The seeded personas
   * carry none: the faces here were hotlinked from stock sites, which
   * put a watermark across one of them and someone else's copyright
   * across all three. The drawn portrait is honest and ours.
   */
  photo?: string;
}
